...
Gem::Specification.new do |spec|
  ...
  spec.homepage = "https://github.com/StrakhovRoman."
  spec.required_ruby_version = Gem::Requirement.new(">= 3.1.0")

  spec.metadata["homepage_uri"] = spec.homepage
  spec.metadata["source_code_uri"] = "https://github.com/StrakhovRoman."
  spec.metadata["changelog_uri"] = "https://github.com/StrakhovRoman."
